...
class ProductController extends Controller
{
    ...
    public function store(Request  $request){
        ...
        // products => this is routs name this i made in routs->namefile
    ...
    public function update(Request  $request,$id){
        ...
        $data= $request->except('_token','main_image','tags','key_ar','key_en','value_ar','value_en','sizes','color_en','color_ar');
        if($request->hasFile('main_image'))
        $data['main_image']=Storage::disk('public')->put('images',$request->file('main_image'));
