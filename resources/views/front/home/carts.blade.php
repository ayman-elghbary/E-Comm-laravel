        ...
        <div class="row">
                        ...
                        <div class="wrap-table-shopping-cart">
                            <table class="table-shopping-cart">
                                ...
                                <tr class="table_row">
                                    ...
                                    <td class="column-2">{{\App\Models\Product::query()->find($item->product->id)->title}}<br>
                                        <span class="font-weight-blod text-primary">
                                            {{$item->size ?? "لم يحدد المقاس"}}
                                        </span><br>
                                        <span class="font-weight-blod text-success">
                                            {{$item->color ?? "لم يحدد اللون"}}
                                        </span>
                                    </td>
                                ...
                                @empty
                                       <tr>
                                        <td colspan="12">
                                        <h4 class="w-100 text-center p-2">لايوجد منتاجات</h4>    
                                        </td>   
                                        </tr> 
                                    @endforelse
            ...
            <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                ...
                <form id="checkout-form" action="{{url('checkout')}}" method="post">
                   @csrf
                <div style="margin-top: 112px" class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
